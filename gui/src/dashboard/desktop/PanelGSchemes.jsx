...
const PanelGSchemes = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (editingScheme) {
      success = await updateScheme(editingScheme._id, formData);
    } else {
      success = await createScheme(formData);
    }
    ...
    <div className="min-h-screen bg-zinc-950 text-white p-8">
      ...
      <div className="flex justify-between items-center mb-10">
        <div>
          ...
          <p className="text-zinc-400 text-sm">
            Manage government schemes and resources
          </p>
        </div>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        {schemes.map((scheme) => (
          ...
          <div
            key={scheme._id}
            onClick={() => navigate(`/dashboard/gov-schemes/${scheme._id}`)}
          ...
          >
            ...
            <div className="h-36 bg-zinc-800 overflow-hidden">
              {scheme.coverImage ? (
                <img
                  src={`http://localhost:4000/${scheme.coverImage}`}
                  alt={scheme.title}
